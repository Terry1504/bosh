...
module Bosh::Director
  describe 'Migrate release_versions table' do
    let(:db) { DBSpecHelper.db }
    let(:migration_file) { '20181219124758_add_update_completed_to_release_versions.rb' }
    ...
    it 'and defaults update_completed to true' do
    ...
    it 'and add entries with optional update_completed and still defaults it to true' do
      DBSpecHelper.migrate(migration_file)
    ...
    it 'and fail when adding null value for update_completed' do
      DBSpecHelper.migrate(migration_file)
